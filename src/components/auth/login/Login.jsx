      ...
      <section className="section text-white h-screen w-full flex items-center py-10  ">
        <div className="container mx-auto ">
          <div className="flex  items-center justify-center md:justify-between w-full ">
            {/* LEFT */}
            <div className="bg-Image w-[50%] md:h-screen hidden md:block">
              {" "}
            </div>
            {/* RIGHT */}
            <div className="w-[80%] md:w-[50%] flex items-center justify-center  ">
              <div className="w-[450px] h-100%   flex flex-col justify-between gap-15   ">
                {/* HEADER */}
                <div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-col gap-7 ">
                        ...
                        <div>
                          {" "}
                          <button
                            className={`w-full p-3 rounded-full  outline flex items-center justify-center gap-2  text-[16px] active
                              ${
                                isSigningIn
                                  ? "cursor-not-allowed"
                          ...
                          >
                            <img
                              src={googleIcon}
                              alt="Google G icon"
                              className="w-6 h-6 mr-3" /* Size the icon & add right margin */
                            />
                            {isSigningIn
                              ? "Signing In..."
